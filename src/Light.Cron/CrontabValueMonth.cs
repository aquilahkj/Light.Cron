...
namespace Light.Cron
{
    class CrontabValueMonth
    {
        ...
        public static bool TryParse(string value, out CrontabValueMonth crontabValue)
        {
            crontabValue = null;
            ...
            foreach (var item in array) {
                if (item == "*" || item == "*/1") {
                    crontabValue = new CrontabValueMonth(null);
                    return true;
                }
            ...
            if (list.Count == 0) {
                ...
                crontabValue = new CrontabValueMonth(list);
                return true;
            }
        }

        CrontabValueMonth(List<CrontabValueNode> list)
        {
            this.list = list;
        }
